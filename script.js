document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showFormSuccess() {
      ...
      if (!successEl) {
        ...
        successEl.style.cssText = 'padding:1rem;background:#c6f6d5;color:#276749;border-radius:0.375rem;margin-top:1rem;text-align:center;';
  ...
  if (animatableElements.length > 0) {
    ...
    style.textContent = [
      '.animate, .fade-in, .fade-in-up, .scroll-animate, .reveal {',
      '  opacity: 0;',
      '  transform: translateY(24px);',
      '  transition: opacity 0.6s ease, transform 0.6s ease;',
      '}',
      '.animate.is-visible, .fade-in.is-visible, .fade-in-up.is-visible,',
      '.scroll-animate.is-visible, .reveal.is-visible {',
      '  opacity: 1;',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "SignQuest uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '559d10fd-ed9d-4540-96b7-295e0e634e3b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '559d10fd-ed9d-4540-96b7-295e0e634e3b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '559d10fd-ed9d-4540-96b7-295e0e634e3b';
